...
| **E7** | `docs/tasks/TASK_E7_market_supply.md` | E5 | 0.5 days | 🔴 Not started |
| **E8** | `docs/tasks/TASK_E8_wire_valuation_flow.md` | E5, E6, E7 | 1-2 days | 🔴 Not started |
| **E9** | `docs/tasks/TASK_E9_valuation_configs.md` | E5-E8 | 0.5 days | 🔴 Not started |
...
**Status**: F1/F2/F3/F8 complete; F4-F7 pending

| Task | File | Dependencies | Effort | Status | Impact |
|------|------|--------------|--------|--------|--------|
| **F1** | `docs/tasks/TASK_F1_profiling_report.md` | None | - | ✅ Complete | Foundation |
| **F8** | `docs/tasks/TASK_F8_benchmark_suite.md` | F1 | 1 day | ✅ Complete | Required |
| **F2** | `docs/tasks/TASK_F2_recruiting_optimization.md` | F8 | 2-3 days | ✅ Complete | 50-70% reduction |
| **F3** | `docs/tasks/TASK_F3_scout_caching.md` | F2 | 1-2 days | ✅ Complete | 20-30% reduction |
...
**Current baseline** (BenchmarkRunner, 2026-01-11): 20-year bootstrap 184.72s, 5-year bootstrap 16.54s
**Target**: Reduce 20-year bootstrap below 150s with no realism loss

**To start next task**: Read `docs/PHASE_F_ROADMAP.md` for overview, then `docs/tasks/TASK_F4_deep_copy_reduction.md`
...
### Performance Follow-ups (Track P)

**Status**: Newly proposed based on BenchmarkRunner results

| Task | File | Dependencies | Effort | Status | Focus |
|------|------|--------------|--------|--------|-------|
| **P1** | `docs/tasks/TASK_P1_phase_timing_capture.md` | F8 | 1 day | 🔴 Not started | World-generation instrumentation |
| **P2** | `docs/tasks/TASK_P2_recruiting_score_cache.md` | F2 | 1-2 days | 🔴 Not started | Recruiting hot-path reduction |
| **P3** | `docs/tasks/TASK_P3_lifecycle_copy_reduction.md` | F4 | 1-2 days | 🔴 Not started | Lifecycle allocation reduction |
